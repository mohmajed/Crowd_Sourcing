Hello,
After you unzip the folder, make sure you are in the crowdsourcing directory in the cmd
you can open the project code with any php editor at any time.
you might need to run the composer install command
npm install
npm run dev
